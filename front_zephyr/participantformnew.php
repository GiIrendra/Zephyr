...
<body>
    <div class="row">
        <div class="col-sm-1" style="float: left">
            ...
            <input type="button" name="sub" class="fadeIn fourth" onclick="window.location.href='mainpage.php'"
                value="Home">
        </div>
    </div>
    ...
    <div class="container">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
            ...
            <button type="submit" name="sub" value="sub" class="button-contact">Submit</button>
        </form>
        <!-- form ends -->
    </div>
    <?php
    // making connection
        include "linc.php";
        // $q1 = "INSERT INTO `ok` ( `name`, `role`,`dt`) VALUES  ('sohan', '','1')";
        ...
        if(isset($_POST["sub"]))
        {
            ...
            if(mysqli_num_rows($resultcheck)==0)
            {
                ...
                $query ="INSERT INTO `participants` (`fname`, `mname`, `lname`, `gender`, `cname`, `ccity`, `cstate`, `course`, `emailid`, `pnumber`, `password`, `vkey`) VALUES ('$fname', '$mname', '$lname', '$gender', '$cname', '$ccity', '$cstate', '$course', '$email', '$pnumber', '$password','')";
                
                // "INSERT INTO `participants` (`p_id`, `fname`, `mname`, `lname`, `gender`, `cname`, `ccity`, `cstate`, `course`, `emailid`, `pnumber`, `password`, `vkey`, `verified`) VALUES (NULL, 'fname', 'manme', 'lnamae', 'gender', 'cname', 'ccity', 'cstate', 'course', 'emailid@gmail.com', '7017319719', '1234', '', '0');"

                // echo "boss is here1";
                // $M_result = mysqli_query($mysqli,$queryM);
                // if ($M_result) {
                //    echo "data created";
                // }
                // else {
                ...
                // SELECT * FROM `participants` WHERE `emailid` LIKE 'sinsinwargirendra@gmail.com'
                 $query2="SELECT * FROM `participants` WHERE `emailid` LIKE '$email'";
